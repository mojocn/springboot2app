...
public class RoleController {
    ...
    public ResponseEntity<Result> all(@RequestParam Integer page, @RequestParam Integer size) {
        ...
        Page<Role> userPage = roleService.findAll(pageable);
    ...
    public ResponseEntity<Result> create(@Valid @RequestBody Role roleRequest) {
    ...
    public ResponseEntity<Result> update(@Valid @RequestBody Role roleRequest) {
