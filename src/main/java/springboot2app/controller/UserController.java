...
public class UserController {
    ...
    public ResponseEntity<Result> getAllUsers(@RequestParam Integer page, @RequestParam Integer size) {
        ...
        Page<UserEntity> userPage = userService.findAll(pageable);
    ...
    public ResponseEntity<Result> create(@Valid @RequestBody UserEntity dto) throws ExceptionBiz {
    ...
    public ResponseEntity<Result> update(@Valid @RequestBody UserEntity dto) throws ExceptionBiz {
